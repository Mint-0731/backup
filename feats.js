...
setup.feats = {
	...
	"Thesis Offence": {
		title: "위법 논문",
		desc: "무력으로 과학적 진실성을 지켜냈다.",
		difficulty: 3,
		series: "scienceFair",
		filter: ["All", "General"],
		hint: "Hint: 과학적이지 않은 것으로 사람들의 눈을 멀게 한다.",
		softLockable: true,
	},
	...
	"Bicycle Mother": {
		title: "자전거 엄마",
		desc: "아빠가 누군지 모르는 아이를 낳았으며, 용의자는 다섯 명 이상이었다.",
		difficulty: 2,
		series: "",
		filter: ["All", "Pregnancy"],
		hint: "Hint: 누가 했는지 알아?",
	...
	"Wet Rod": {
		title: "젖은 낚싯대",
		desc: "모든 종류의 물고기를 잡았다.",
		difficulty: 2,
		series: "fishing",
		filter: ["All", "Discoveries-Other"],
		hint: "Hint: 낚시 기록을 완성한다.",
	},
	"Master Baiter": {
		title: "낚시의 달인",
		desc: "모든 종류의 거대한 물고기를 잡았다.",
		difficulty: 3,
		series: "fishing",
		filter: ["All", "Discoveries-Other"],
		hint: "Hint: 모든 물고기의 거대 개체를 잡는다.",
	},
	"Nice Bass": {
		title: "근사한 배스",
		desc: "배스를 잡았다.",
	...
	"Stomping Down The Street": {
		title: "거리의 쿵쾅거림",
		desc: "하이 가에서 많은 전단지를 나눠주었다.",
		difficulty: 1,
		series: "Flyers",
		filter: ["All", "Discoveries-Town"],
		hint: "Hint: 니키와 함께 일한다.",
		softLockable: true,
	},
	"Record Keeper": {
		title: "기록 관리자",
		desc: "정신병원의 금지된 사무실을 정리했다.",
		difficulty: 1,
		series: "",
		filter: ["All", "Discoveries-Other"],
		hint: "Hint: 정신병원에서 가사 기술을 숙련한다.",
		softLockable: true,
	},
	"Bramble Tamer": {
		title: "가시덤불 조련사",
		desc: "정신병원의 비밀 정원을 복원했다.",
		difficulty: 1,
		series: "",
		filter: ["All", "Discoveries-Other"],
		hint: "Hint: 정신병원에서 관리 기술을 숙련한다.",
		softLockable: true,
	},
	"Eyes in the Night": {
		title: "밤의 눈",
		desc: "정신병원의 터널에서 괴물을 풀어주었다.",
		difficulty: 1,
		series: "",
		filter: ["All", "Discoveries-Other"],
		hint: "Hint: 정신병원에서 수영 기술을 숙련한다.",
		softLockable: true,
	},
	"Mirror Madness": {
		title: "거울의 광기",
		desc: "고대의 거울 치료법을 사용했다.",
		difficulty: 2,
		series: "",
		filter: ["All", "Discoveries-Other"],
		hint: "Hint: 정신병원의 금지된 구역을 탐험한다.",
		softLockable: true,
	},
	"Hear Me Roar": {
		title: "나의 포효를 들으라",
		desc: "하이 가에서 아주 많은 전단지를 나눠주었다.",
		difficulty: 2,
		series: "Flyers",
		filter: ["All", "Discoveries-Town"],
		hint: "Hint: 니키와 함께 일한다.",
	...
	if (localStorageSaves) {
		if (localStorageSaves.autosave) {
			...
			try {
				...
				console.warn("업적 정보를 불러오는 동안 저장 파일의 압축을 풀 수 없었습니다. 해당 단계를 건너뜁니다.", e);
			}
...
function earnHourlyFeats() {
	...
	if (V.spraymax > 8) console.warn("후추 스프레이의 소지 수가 8 이상입니다! 저희가 업적 달성 기준치를 높여야 할까요?");
...
function setupFeatBoosts(force) {
	...
	const boostData = {
		...
		seeds: {
			...
			cost: 0,
			missing: "이 부스트는 '가득한 씨앗' 업적을 달성하면 해금됩니다",
		},
		sexToys: {
			name: "섹스 장난감",
